...
exports.login = function(req, res){
    ...
    // if promise is successful -> then() execute // if promise fails execute -> catch()
 ...
 exports.apiLogin = function(req, res){
     ...
     // if promise is successful -> then() execute // if promise fails execute -> catch()
     user.login().then(function(result){
         res.json(jwt.sign({_id: user.data._id}, process.env.JWTSECRET, {expiresIn: '2h'}))   // JWT SIGN {Any data you want to store},  JWT SECRET, EXPIRYDATE
     }).catch(function(e){
         res.json("Your credentials are wrong!")
     })
 } 
...
exports.profilePostsScreen = function(req, res){
    ...
    // get posts from post model for a certain author id
